...
const initPayment = async (payload: any) => {
  try {
    const data = {
      ...
      success_url: "https://frontend-mb-tousif.vercel.app/",
      fail_url: "https://frontend-mb-tousif.vercel.app/faild",
      cancel_url: "https://frontend-mb-tousif.vercel.app/cancel",
