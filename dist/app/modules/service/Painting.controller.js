...
const getAllAvailableServices = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const options = (0, pick_1.default)(req.query, pagination_1.paginationFields);
    const filterOptions = (0, pick_1.default)(req.query, Painting_constants_1.serviceFilterableFieldsForPublicApi);
    const result = yield Painting_service_1.PaintingService.getAllAvailableServices(options, filterOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getAllUpcomingServices = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const options = (0, pick_1.default)(req.query, pagination_1.paginationFields);
    const filterOptions = (0, pick_1.default)(req.query, Painting_constants_1.serviceFilterableFieldsForPublicApi);
    const result = yield Painting_service_1.PaintingService.getAllUpcomingServices(options, filterOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: "Upcoming all services fetched",
