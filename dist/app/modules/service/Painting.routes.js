...
// Get all services
router.get('/all-services', (0, auth_1.default)(common_1.ENUM_USER_ROLE.SUPER_ADMIN, common_1.ENUM_USER_ROLE.ADMIN, common_1.ENUM_USER_ROLE.USER), Painting_controller_1.PaintingController.getAllServices);
// Get all Available services
router.get('/all-available-services', Painting_controller_1.PaintingController.getAllAvailableServices);
// Get all Upcoming services
router.get('/all-upcoming-services', Painting_controller_1.PaintingController.getAllUpcomingServices);
// Get service by id
