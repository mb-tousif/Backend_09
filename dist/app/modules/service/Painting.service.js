...
const getAllAvailableServices = (options, payload) => __awaiter(void 0, void 0, void 0, function* () {
    // Handle pagination, custom query, search and filtration
    const { search, minPrice, maxPrice } = payload, filterData = __rest(payload, ["search", "minPrice", "maxPrice"]);
    const { page, limit, sortBy, sortOrder } = paginationHelper_1.paginationHelpers.calculatePagination(options);
    const query = {
        where: {
            ...
            AND: [
                ...
                search
                    ? {
                        OR: Painting_constants_1.serviceSearchableFieldsForPublicApi.map((field) => ({
                            [field.toString()]: {
                                contains: search,
                                mode: "insensitive",
                            },
...
const getAllUpcomingServices = (options, payload) => __awaiter(void 0, void 0, void 0, function* () {
    // Handle pagination, custom query, search and filtration
    const { search, minPrice, maxPrice } = payload, filterData = __rest(payload, ["search", "minPrice", "maxPrice"]);
    const { page, limit, sortBy, sortOrder } = paginationHelper_1.paginationHelpers.calculatePagination(options);
    const query = {
