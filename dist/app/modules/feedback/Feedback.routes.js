...
router.patch("/update-feedback/:id", (0, auth_1.default)(common_1.ENUM_USER_ROLE.ADMIN, common_1.ENUM_USER_ROLE.SUPER_ADMIN, common_1.ENUM_USER_ROLE.USER), (0, validateRequest_1.default)(Feedback_zod_validation_1.FeedbackValidation.updateValidation), Feedback_controller_1.FeedbackController.updateFeedbackById);
