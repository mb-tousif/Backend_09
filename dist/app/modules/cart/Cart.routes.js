...
router.get('/user-carts', (0, auth_1.default)(common_1.ENUM_USER_ROLE.USER), Cart_controller_1.CartController.getCartsByUserId);
// Get Cart by id
...
router.patch("/increment-cart-quantity/:id", (0, auth_1.default)(common_1.ENUM_USER_ROLE.USER), Cart_controller_1.CartController.incrementCartQuantity);
router.patch("/decrement-cart-quantity/:id", (0, auth_1.default)(common_1.ENUM_USER_ROLE.USER), Cart_controller_1.CartController.decrementCartQuantity);
// Update Cart by id
