...
const createSubscribe = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Subscribe_service_1.SubscribeService.createSubscribe(payload);
...
const getAllSubscribes = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const options = (0, pick_1.default)(req.query, pagination_1.paginationFields);
    const result = yield Subscribe_service_1.SubscribeService.getAllSubscribes(options);
    (0, sendResponse_1.default)(res, {
...
const deleteSubscribeById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const SubscribeId = req.params.id;
    const result = yield Subscribe_service_1.SubscribeService.deleteSubscribeById(SubscribeId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
